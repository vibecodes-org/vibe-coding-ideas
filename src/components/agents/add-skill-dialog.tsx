...
const CATEGORIES = ["All", "Development", "Creative", "Enterprise", "Document", "Cloud"] as const;
...
function getCategoryBadgeClass(category: string | null): string {
  switch (category) {
    ...
    case "Cloud": return "bg-blue-500/12 text-blue-400 border-blue-500/25";
...
export function AddSkillDialog({
  ...
  // Derive available providers from fetched skills
  const providers = ["All", ...Array.from(new Set(skills.map((s) => s.provider))).sort()];
