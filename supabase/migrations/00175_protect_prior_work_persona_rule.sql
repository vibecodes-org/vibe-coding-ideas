...
-- the 16 platform seed agents AND every existing clone of them (clones are
-- copies, not references — see mcp-server/src/tools/bots.ts,
...
-- the 16 platform agent ids plus rows cloned_from one of those ids, per
-- Nick's binding correction on the implementation plan.
--
